...
export default function PendingOrderDetailsModal({ show, handleClose, order, handleAccept }) {
    ...
    return (
        <Modal show={show} onHide={handleClose} centered className='modal-xl'>
            ...
            <Modal.Footer className="justify-content-center">
                <Button className='fs-5' variant="primary rounded-pill" onClick={handleAccept}>
                    POTVRDIŤ
                </Button>
